...
const Auth: React.FC<AuthProps> = ({
    ...
    return (
        <div className="justify-center xl:items-center lg:items-center md:items-center items-end flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-auth bg-black">
            <Link
                href="/"
